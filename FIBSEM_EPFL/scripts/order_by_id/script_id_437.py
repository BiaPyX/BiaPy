...
img_train_shape = [4669, 4669, 1]
img_test_shape = [4669, 4669, 1]
...
normalize_data = True
norm_value_forced = 73.31451529156946
custom_da = False
...
fine_tunning = True # Only valid with load_previous_weights==False
...
if load_previous_weights == False:
    ...
    if fine_tunning == True:
        h5_file=os.path.join(h5_dir, 'model.fibsem_429_' + test_id + '.h5')
