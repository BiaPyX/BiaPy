...
fine_tunning = False # Only valid with load_previous_weights==False
...
det_eval_ge_path = os.path.join('cell_challenge_eval', 'general_r_fib_fib')
...
if load_previous_weights == False:
    ...
    if fine_tunning == True:
        h5_file=os.path.join(h5_dir, 'model.fibsem_428_' + test_id + '.h5')
