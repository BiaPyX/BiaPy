...
train_path = os.path.join('lucchi_pp', 'reshaped_achucarro', 'hist_matching',  'train', 'x')
train_mask_path = os.path.join('lucchi_pp', 'reshaped_achucarro', 'hist_matching',  'train', 'y')
test_path = os.path.join('lucchi_pp', 'reshaped_achucarro', 'hist_matching',  'test', 'x')
test_mask_path = os.path.join('lucchi_pp', 'reshaped_achucarro', 'hist_matching',  'test', 'y')
...
img_train_shape = [748, 561, 1]
img_test_shape = [748, 561, 1]
