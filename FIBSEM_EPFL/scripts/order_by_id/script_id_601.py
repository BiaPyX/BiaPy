...
Print("X_val.dtype: " + str(X_val.dtype))                                       
Print("X_test.dtype: " + str(X_test.dtype))                                     
Print("Mean X_train: " + str(np.mean(X_train)))                                 
Print("Mean X_val: " + str(np.mean(X_val)))                                     
Print("Mean X_test: " + str(np.mean(X_test)))                                   
Print("Max X_train: " + str(np.amax(X_train)))                                  
Print("Max X_val: " + str(np.amax(X_val)))                                      
Print("Max X_test: " + str(np.amax(X_test)))                                    
Print("Min X_train: " + str(np.amin(X_train)))                                  
Print("Min X_val: " + str(np.amin(X_val)))                                      
Print("Min X_test: " + str(np.amin(X_test)))                                    
Print("1-Mean X_train: " + str(np.mean(X_train[0])))                            
Print("1-Mean X_val: " + str(np.mean(X_val[0])))                                
Print("1-Mean X_test: " + str(np.mean(X_test[0])))                              
Print("1-Max X_train: " + str(np.amax(X_train[0])))                             
Print("1-Max X_val: " + str(np.amax(X_val[0])))                                 
Print("1-Max X_test: " + str(np.amax(X_test[0])))                               
Print("1-Min X_train: " + str(np.amin(X_train[0])))                             
Print("1-Min X_val: " + str(np.amin(X_val[0])))                                 
Print("1-Min X_test: " + str(np.amin(X_test[0])))
Print("#############")
