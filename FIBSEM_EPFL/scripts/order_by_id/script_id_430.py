...
# Dataset variables
train_path = os.path.join('achucarro', 'sin_retocar2', 'train', 'x')
train_mask_path = os.path.join('achucarro', 'sin_retocar2', 'train', 'y')
test_path = os.path.join('achucarro', 'sin_retocar2', 'test', 'x')
test_mask_path = os.path.join('achucarro', 'sin_retocar2', 'test', 'y')
...
det_eval_ge_path = os.path.join('cell_challenge_eval', 'general_achu_rfib')
