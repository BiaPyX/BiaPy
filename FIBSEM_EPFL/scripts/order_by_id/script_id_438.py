...
# Dataset variables
train_path = os.path.join('data', 'reshaped_kasthuri', 'train', 'x')
train_mask_path = os.path.join('data', 'reshaped_kasthuri', 'train', 'y')
test_path = os.path.join('data', 'reshaped_kasthuri', 'test', 'x')
test_mask_path = os.path.join('data', 'reshaped_kasthuri', 'test', 'y')
