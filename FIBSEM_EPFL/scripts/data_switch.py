...
class ImageDataGenerator(keras.utils.Sequence):
    ...
    def __init__(self, X, Y, batch_size=32, dim=(256,256), n_channels=1,
       ...
       Args:
        ...
        self.t_counter = [0 ,0 ,0 ,0 ,0 ,0, 0]

        # Choices to index faster transformations
        self.choices  = []
    ...
    def apply_transform(self, image, mask, flow=False):
        ...
        # [0.75-1]: nothing
        #
        # Select one of the flip transformations randomly
        ...
        # Vertical and horizontal flip
            ...
            trans_image = np.flip(trans_image, 1)
            trans_mask = np.flip(trans_mask, 1)
            transform_string = transform_string + '_vf+hf'
            transformed = True
        ...
        if (self.rotation == True or flow == True) and 0.5 <= prob < 0.75:
            ...
            transformed = True
            self.t_counter[6] = self.t_counter[6] + 1
    ...
    def flow_on_examples(self, num_examples, job_id="none_job_id",
        ...
        """ Apply selected transformations to a defined number of images from
            ...
            Args:
                ...
                of the dataset.
        """
        print("\nCreating the examples of data augmentation . . .")
