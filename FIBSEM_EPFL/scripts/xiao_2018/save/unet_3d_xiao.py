...
import keras 
from metrics import binary_crossentropy_weighted, jaccard_index_softmax
...
def U_Net_3D_Xiao(image_shape, activation='elu', numInitChannels=16, 
    ...
    a1 = Reshape((20*256*256, num_classes), input_shape = (20, 256, 256, num_classes)) (a1)
    a1 = Permute((2,1))(a1)
    ...
    a2 = Reshape((20*256*256, num_classes), input_shape = (20, 256, 256, num_classes)) (a2)
    a2 = Permute((2,1))(a2)
    ...
    x = Conv3D(num_classes, (1, 1, 1), activation=None, 
               kernel_initializer='he_normal', padding='same')(x)
    x = Reshape((20*256*256, num_classes), input_shape = (20, 256, 256, num_classes)) (x)
    x = Permute((2,1))(x)
