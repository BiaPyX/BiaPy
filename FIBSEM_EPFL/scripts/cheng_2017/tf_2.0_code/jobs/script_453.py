...
# Dataset variables
train_path = os.path.join('data', 'reshaped_achucarro', 'train', 'x')
train_mask_path = os.path.join('data', 'reshaped_achucarro', 'train', 'y')
test_path = os.path.join('data', 'reshaped_achucarro', 'test', 'x')
test_mask_path = os.path.join('data', 'reshaped_achucarro', 'test', 'y')
