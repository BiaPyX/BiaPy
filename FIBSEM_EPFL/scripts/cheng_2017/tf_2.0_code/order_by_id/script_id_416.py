...
make_crops = False
check_crop = False
random_crops_in_DA = True # No compatible with make_crops                                                        
test_ov_crops = 12 # Only active with random_crops_in_DA
...
adabound = AdaBound(lr=learning_rate_value, final_lr=0.1, gamma=1e-03, 
                    weight_decay=0., amsbound=False)

model.compile(optimizer=adabound, loss='binary_crossentropy', 
