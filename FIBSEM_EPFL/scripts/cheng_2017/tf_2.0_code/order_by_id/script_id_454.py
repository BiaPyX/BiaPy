...
# Dataset variables
train_path = os.path.join('kasthuri_pp', 'reshaped_achucarro', 'train', 'x')
train_mask_path = os.path.join('kasthuri_pp', 'reshaped_achucarro', 'train', 'y')
test_path = os.path.join('kasthuri_pp', 'reshaped_achucarro', 'test', 'x')
test_mask_path = os.path.join('kasthuri_pp', 'reshaped_achucarro', 'test', 'y')
...
img_train_shape = [640, 706, 1]
img_test_shape = [584, 680, 1]
...
normalize_data = True
norm_value_forced = 182.7545564174652
custom_da = False
...
if custom_da == False:                                                          
    ...
    val_generator = keras_da_generator(X_train=X_train, Y_train=Y_train, 
                                       ...
                                       shuffle_train=False, zoom=keras_zoom,        
                                       random_crops_in_DA=random_crops_in_DA,
                                       crop_length=crop_shape[0],
...
if load_previous_weights == False:
    ...
    h5_file=os.path.join(h5_dir, 'model.fibsem_443_' + test_id + '.h5')
