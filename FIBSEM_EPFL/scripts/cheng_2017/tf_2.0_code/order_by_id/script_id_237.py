...
train_crop_discard_path = os.path.join('data_d', 'achu_' + str(d_percentage_value), 'train', 'x')
train_crop_discard_mask_path = os.path.join('data_d', 'achu_' + str(d_percentage_value), 'train', 'y')
test_crop_discard_path = os.path.join('data_d', 'achu_' + str(d_percentage_value), 'test', 'x')
test_crop_discard_mask_path = os.path.join('data_d', 'achu_' + str(d_percentage_value), 'test', 'y')
