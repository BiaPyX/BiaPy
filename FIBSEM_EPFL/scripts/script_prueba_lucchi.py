...
if make_crops == True:                                                          
    TRAIN_CROP_DISCARD_PATH = os.path.join('data_d', 'luc_'                     
                              + str(d_percentage_value), 'train', 'x')          
    TRAIN_CROP_DISCARD_MASK_PATH = os.path.join('data_d', 'luc_'                
                                   + str(d_percentage_value), 'train', 'y')     
    TEST_CROP_DISCARD_PATH = os.path.join('data_d', 'luc_'                      
                             + str(d_percentage_value), 'test', 'x')            
    TEST_CROP_DISCARD_MASK_PATH = os.path.join('data_d', 'luc_'                 
