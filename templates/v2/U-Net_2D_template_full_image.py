...
from util import limit_threads, set_seed, create_plots, store_history,\
                 ...
                 img_to_onehot_encoding, check_downsample_division
limit_threads()
...
if in_memory:
    ...
    filenames = load_and_prepare_2D_data(
        ...
        crop_test=False)
    X_test, _ = check_downsample_division(X_test, depth)
    Y_test, o_test_shape = check_downsample_division(Y_test, depth)
else:
