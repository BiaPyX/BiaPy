...
data_gen_args = dict(
    ...
    shuffle=shuffle_train_data_each_epoch, da=True, rotation90=rotation90,
    rotation_range=rotation_range, vflip=vflips, hflip=hflips, elastic=elastic,
    g_blur=g_blur, median_blur=median_blur, gamma_contrast=gamma_contrast,
...
score_per_crop = model.evaluate(                                                
    [X_test], [Y_test]*out_number, batch_size=batch_size_value, verbose=1)
