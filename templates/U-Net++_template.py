...
# To run U-Net++ you need to clone the repository of the U-Net++ code. We adapted
# the original implementation of https://github.com/MrGiovanni/UNetPlusPlus/tree/master/keras
# to our Tensorflow and Keras versions so you could just use it:
#       
#       git clone https://github.com/danifranco/UNetPlusPlus.git
# Then define the following variable to the path you cloned the repo. E.g. 
#       unetpp_path = "/data2/dfranco/UNetPlusPlus/keras"
# This will allow the usage of they code to build the network. They named in the 
# code as 'Xnet'. 
...
# Create 3 channel images concatenating the same grayscale ones as U-Net++ is
# designed to input 3 channel images
...
orig_test_shape = orig_test_shape[:3]+(3,)                                      
