...
X_train_augmented = X_datagen.flow(X_train, batch_size=batch_size_value, seed=seedValue)
Y_train_augmented = Y_datagen.flow(Y_train, batch_size=batch_size_value, seed=seedValue)
X_test_augmented = X_datagen_val.flow(X_val, batch_size=batch_size_value, seed=seedValue)
Y_test_augmented = Y_datagen_val.flow(Y_val, batch_size=batch_size_value, seed=seedValue)
