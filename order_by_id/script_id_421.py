...
extra_datasets_data_list.append(os.path.join('vnc', 'reshaped_fibsem', 'train', 'x'))
extra_datasets_mask_list.append(os.path.join('vnc', 'reshaped_fibsem', 'train', 'y'))
extra_datasets_data_dim_list.append([942, 942, 1])                            
extra_datasets_discard.append(0.00)
### Example of use:
# Path to the data:
# extra_datasets_data_list.append(os.path.join('kasthuri_pp', 'reshaped_fibsem', 'train', 'x'))
