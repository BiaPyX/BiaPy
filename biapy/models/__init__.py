...
def build_model(
    ...
    # import biapy
    # arch_file_path = os.path.join("/data/dfranco", os.path.basename(model_file))
    ...
    #     for line in scanned_files:
    #         f.write("#     - " + line + "\n")
    #     f.write("\n\n")
    #     for line in all_import_lines:
    #         f.write(line + "\n")
    #     f.write("\n")
    #     for _, src in collected_sources.items():
    #         f.write(src + "\n\n")

    # print("✅ model.py created with {} components.".format(len(collected_sources)))
    # from biapy.utils.util import create_file_sha256sum
    # print(create_file_sha256sum(arch_file_path))
