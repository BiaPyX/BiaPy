...
sys.path.insert(0, os.path.join(script_dir, '..', 'xiao_2018'))
...
img_3d_desired_shape = (20, 256, 256, 1)
...
model = U_Net_3D_Xiao(img_3d_desired_shape, numInitChannels=num_init_channels, 
...
#layer_output = get_softmax_layer_output([X_train[0:2], 1])
#a = np.array(layer_output)
#print("layer_output.type: {}".format(type(a)))
#print("layer_output.shape: {}".format(a.shape))
#print("TERMINADO")
#sys.exit(0)
#################
...
if load_previous_weights == False:
    ...
    print("validation_steps: {}".format(math.ceil(len(X_val)/batch_size_value))) 
