...
train_path = os.path.join('data', 'reshaped_achucarro', 'hist_matching', 'train', 'x')
train_mask_path = os.path.join('data', 'reshaped_achucarro', 'hist_matching', 'train', 'y')
test_path = os.path.join('data', 'reshaped_achucarro', 'hist_matching', 'test', 'x')
test_mask_path = os.path.join('data', 'reshaped_achucarro', 'hist_matching', 'test', 'y')
