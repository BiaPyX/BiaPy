...
`[Paper] <https://ieeexplore.ieee.org/document/8217827>`_ `[Our code] <https://github.com/danifranco/BiaPy/tree/v1.0/sota_implementations/oztel_2017>`_

We have prepared one template:

    -  `oztel_template_V0.py <https://github.com/danifranco/BiaPy/tree/v1.0/sota_implementations/oztel_2017/oztel_template_V0.py>`_ : exact parameters and training workflow as described in the paper.
    -  `oztel_template_V1.py <https://github.com/danifranco/BiaPy/tree/v1.0/sota_implementations/oztel_2017/oztel_template_V1.py>`_ : own changes made V0 to achieve better results.
