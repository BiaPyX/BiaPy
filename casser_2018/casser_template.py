...
# Range of rotation. Available for both Keras and custom DA
rotation_range = 180
...
if custom_da == False:                                                          
    ...
    if aug_examples == True:                                                    
        ...
        val_generator.get_transformed_samples(
            17, save_to_dir=True, train=False, out_dir=da_samples_dir+"_val", random_images=False)
